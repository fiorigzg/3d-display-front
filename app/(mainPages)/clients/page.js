...
export default function Home() {
  ...
  let filtredClients = clientsStore.clients.filter((client) =>
    client.name.includes(clientsStore.clientNameFilter),
  );
      ...
      productsArr.push(
        <Subblock key={product.id}>
          <VInput
            value={product.name}
            onChange={(value) =>
              clientsStore.setProductValue(client.id, product.id, "name", value)
            }
          ...
          <HInput
            ...
            onChange={(value, files) =>
              clientsStore.setProductValue(client.id, product.id, "object", {
                value: value,
                files: files,
              })
            }
    ...
    clientsArr.push(
      <Block key={client.id}>
        <VInput
          value={client.name}
          onChange={(value) =>
            clientsStore.setClientValue(client.id, "name", value)
          }
          onEnter={(value) => updateClient(client.id, "name", value)}
